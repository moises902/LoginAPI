...
func NewMedicareAPI(spec *loads.Document) *MedicareAPI {
	return &MedicareAPI{
		...
		RecordGetRecordHandler: record.GetRecordHandlerFunc(func(params record.GetRecordParams) middleware.Responder {
			return middleware.NotImplemented("operation record.GetRecord has not yet been implemented")
		}),
		RecordsGetRecordsHandler: records.GetRecordsHandlerFunc(func(params records.GetRecordsParams) middleware.Responder {
			return middleware.NotImplemented("operation records.GetRecords has not yet been implemented")
		}),
...
/*MedicareAPI API used to get medicare data */
type MedicareAPI struct {
	...
	// RecordGetRecordHandler sets the operation handler for the get record operation
	RecordGetRecordHandler record.GetRecordHandler
	// RecordsGetRecordsHandler sets the operation handler for the get records operation
	RecordsGetRecordsHandler records.GetRecordsHandler
...
func (o *MedicareAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *MedicareAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}
...
func (o *MedicareAPI) Validate() error {
	...
	if o.RecordGetRecordHandler == nil {
		unregistered = append(unregistered, "record.GetRecordHandler")
	}
	if o.RecordsGetRecordsHandler == nil {
		unregistered = append(unregistered, "records.GetRecordsHandler")
	}
...
func (o *MedicareAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/record"] = record.NewGetRecord(o.context, o.RecordGetRecordHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/records"] = records.NewGetRecords(o.context, o.RecordsGetRecordsHandler)
...
func (o *MedicareAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
